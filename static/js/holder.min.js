    ...
    return function (e) {
        ...
        (function (t) {
                    ...
                    version: A.version, addTheme: function (e, t) {
                        ...
                        return n.stylesheets = [], n.svgXMLStylesheet = !0, n.noFontFallback = !!a.noFontFallback, n.noBackgroundSize = !!a.noBackgroundSize, h.forEach(function (e) {
                            ...
                            if (t.getComputedStyle) {
                                var r = t.getComputedStyle(e, null).getPropertyValue("background-images"),
            ...
            O.setup = {
                ...
                e.getContext && e.toDataURL("images/png").indexOf("data:images/png") != -1 && (O.setup.renderer = "canvas", O.setup.supportsCanvas = !0), document.createElementNS && document.createElementNS(j, "svg").createSVGRect && (O.setup.renderer = "svg", O.setup.supportsSVG = !0)
            }(), d(), m && m(function () {
        ...
        (function (e) {
            ...
            t.initSVG = function (e, t, n) {
                ...
                var t = "data:images/svg+xml;charset=UTF-8,", n = "data:images/svg+xml;charset=UTF-8;base64,";
                return function (r, i) {
